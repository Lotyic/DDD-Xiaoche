...
void DJ_MOVE_BUFF_SET(u8 t,u8 f)        //只需要看这个函数，车的移动全靠这个函数
{
	u8 sp;
...
void HAND_FUWEI(void)//机械臂复位
{	
	
}
void HAND_ZHUA(void)//机械臂抓
{	
	
}

void HAND_FANG(void)//机械臂放
{
