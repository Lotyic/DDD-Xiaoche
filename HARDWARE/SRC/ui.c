...
char zhiling[][20] = {
	...
	"$DGT:4-4,1!", //拿地上环放爪	   	 	 3
	"$DGT:5-8,1!", //拿地上环				4				
	"$DGT:33-38,1!", //拿增益环 还没写 			5				
	"$DGT:14-18,1!", //放三分  				6				
	"$DGT:9-13,1!", //放二分				7	
	"$DGT:19-19,1!", //爪子前伸保持重心		 8		
};
...
unsigned char oo11[][5] = {
			{0,200,30,0,2},
			{0,1,20,255,0},{0,2,0,0,20},{2,1,0,255,0},{0,4,0,255,0},{0,2,0,3,16},{2,1,0,255,0},{0,2,0,4,35},{0,3,0,255,1},{0,2,0,3,14},{2,1,0,255,0},{0,2,0,4,50},
			{0,2,0,1,10},{2,1,0,255,0},{0,4,0,255,0},{3,1,0,255,1},{0,4,0,255,0},{4,1,0,255,0},
			{0,6,0,255,0},{0,1,40,255,0},{0,1,40,255,10},{0,0,40,255,0},{0,0,40,255,10},{0,6,0,255,0},
			{0,2,0,0,10},{1,1,0,255,0},{0,2,0,7,80},{1,0,0,255,0},{0,0,23,255,10},{0,3,0,255,10},{1,1,0,255,0},{0,4,0,255,0},{1,1,0,255,0},
			{0,3,0,255,0},{0,2,0,3,14},{3,1,0,255,0},{0,2,0,4,35},
			{0,1,0,3,14},{2,1,0,255,0},{0,1,0,4,50},{0,3,0,255,0},
			{1,1,0,255,0},{0,3,0,255,10},{0,1,30,255,0},{0,2,0,6,60},
                   ...
                   {0,0,0,0,0},};//对抗初启1中  双车完胜
unsigned char oo12[][5] = {		
			{0,1,27,0,4},{0,2,0,3,10},{1,1,0,255,0},{0,2,0,4,25},{0,2,0,3,10},{2,1,0,255,0},{0,2,0,4,30},
			{0,4,0,255,2},{0,2,0,1,10},{5,1,0,255,0},{0,4,0,255,5},{2,1,0,255,0},
			{0,6,0,255,0},{0,1,40,255,0},{0,1,30,255,10},{0,0,40,255,0},{0,0,30,255,0},{0,6,0,255,0},{0,2,0,0,1},
			{0,1,130,255,0},{0,2,0,7,45},{2,0,0,255,0},{0,0,15,255,0},{0,3,0,255,0},{1,1,0,255,0},
			{0,2,0,3,14},{3,1,0,255,0},{0,2,0,4,30},{0,2,0,3,14},{2,1,0,255,0},{0,2,0,4,25},{0,4,0,255,10},
			{1,1,0,255,0},{0,4,0,255,10},{0,1,31,255,0},{0,2,0,6,35},			//此时如果全部成功则为2 2 2

			{0,0,20,255,0},{0,3,0,3,10},{1,1,0,4,25},{0,4,0,3,10},{2,1,0,4,25},{0,4,0,255,0},{1,1,0,255,0},{0,4,0,255,0},{0,1,40,255,0},{0,2,0,6,30},
...
unsigned char oo13[][5] = {
			{0,200,20,0,1},{0,1,20,255,0},{0,2,0,0,1},{1,1,0,255,0},{0,4,0,255,0},
	
	
			 {0,0,0,0,0},};//对抗初启3中 测试双车
unsigned char oo14[][5] = {
			 {2,1,0,0,1},{0,1,100,255,0},{0,1,100,255,0},{0,1,100,255,0},{0,1,100,255,0},{0,1,100,255,0},
			 {0,0,0,0,0},};//偷，远右边角，放1分√
