...
unsigned char oo12[][5] = {		
			...
			{0,1,130,255,0},{0,2,0,7,45},{2,0,0,255,0},{0,0,15,255,0},{0,3,0,255,0},{3,1,0,255,0},
			{0,2,0,3,14},{1,1,0,255,0},{0,2,0,4,30},{0,2,0,3,14},{2,1,0,255,0},{0,2,0,4,25},{0,4,0,255,10},
			{1,1,0,255,0},{0,4,0,255,10},{0,1,31,255,0},{0,2,0,6,38},			//此时如果全部成功则为2 2 2
